...
const TableChart = (teamDomain:string) => {
        ...
        const fetchData = async () => {
            try {
                const response: AmplitudeResponse = await fetchAmplitudeData(
                    `/2/events/segmentation?e={"event_type":"[Amplitude] Page Viewed","group_by":[{"type":"user","value":"country"}]}&start=20240101&end=20240130`, teamDomain
                );
