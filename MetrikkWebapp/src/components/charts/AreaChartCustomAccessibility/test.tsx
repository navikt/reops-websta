...
import { AreaChart, DataVizPalette, ILegend, Legends } from '@fluentui/react-charting';
...
export class Test extends React.Component<NonNullable<unknown>, IAreaChartCustomAccessibilityState> {
